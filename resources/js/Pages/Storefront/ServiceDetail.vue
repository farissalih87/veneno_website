      ...
      <div class="glass-panel p-5 sm:p-10 rounded-2xl sm:rounded-3xl border border-zinc-800 space-y-4 sm:space-y-6 relative overflow-hidden">
        ...
        <div class="pt-2 grid grid-cols-2 sm:flex items-center gap-2.5 sm:gap-3.5">
          ...
          <a
            ...
            class="px-4 sm:px-6 py-3.5 sm:py-4 rounded-xl sm:rounded-2xl bg-emerald-950/80 hover:bg-emerald-900 border border-emerald-500/50 text-emerald-300 hover:text-white font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-lg text-center"
          >
