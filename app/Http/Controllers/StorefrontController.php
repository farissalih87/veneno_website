    ...
    public static function getOfficialServices(string $locale = 'en'): array
    {
        ...
        return [
            [
                ...
                'before_label' => $isAr ? 'قبل: أسود لامع (وكالة)' : 'Before: Gloss Black (OEM)',
            ...
            [
                ...
                'before_image' => '/images/before-after/aston-martin-side-before.jpg',
                'after_image' => '/images/before-after/aston-martin-side-after.jpg',
                'before_label' => $isAr ? 'قبل: طلاء أسود بدون حماية' : 'Before: Unprotected Paint',
                'after_label' => $isAr ? 'بعد: درع نانو سيراميك 9H وانعكاس مرآة' : 'After: 9H GYEON Ceramic Hydrophobic Shield',
            ...
            [
                ...
                'before_label' => $isAr ? 'قبل: لكر متقشر وتالف من الشمس' : 'Before: Sun-Damaged Faded Clearcoat',
                'after_label' => $isAr ? 'بعد: تسوية مجهرية بالليزر وتجديد كامل' : 'After: Resurfaced Concourse Leveling',
            ...
            [
                ...
                'before_image' => '/images/before-after/aston-martin-side-before.jpg',
                'after_image' => '/images/before-after/aston-martin-side-after.jpg',
                'before_label' => $isAr ? 'قبل: زجاج عادي بنفاذية حرارية عالية' : 'Before: Standard Glass (High Heat)',
                'after_label' => $isAr ? 'بعد: عازل نانو سيراميك 3M بعزل 98% حرارة' : 'After: 3M Nano-Ceramic Heat Shield',
                'warranty' => $isAr ? 'ضمان مدى الحياة' : 'Lifetime Warranty',
                'duration_hours' => 3,
                'features' => $isAr ? [
            ...
            [
                ...
                'before_image' => '/images/before-after/ferrari-488-gtb-before.jpg',
                'after_image' => '/images/before-after/ferrari-488-gtb-after.jpg',
                'before_label' => $isAr ? 'قبل: انبعاج بهيكل الوكالة الأصلي' : 'Before: Factory Panel Defect',
            ...
            [
                ...
                'before_image' => '/images/before-after/audi-r8-front-before.jpg',
                'after_image' => '/images/before-after/audi-r8-front-after.jpg',
                'before_label' => $isAr ? 'قبل: تشطيب متآكل وباهت' : 'Before: Scuffed & Oxidized Finish',
                'after_label' => $isAr ? 'بعد: تشطيب فائق اللمعان وحماية كليبرات' : 'After: High-Gloss Armor & Caliper Detail',
                'warranty' => $isAr ? 'ضمان جودة التشطيب' : 'Finish Durability Guaranteed',
                'duration_hours' => 4,
                'features' => $isAr ? [
            ...
            [
                ...
                'before_image' => '/images/before-after/defender-interior-before.jpg',
                'after_image' => '/images/before-after/defender-interior-after.jpg',
                'before_label' => $isAr ? 'قبل: مقصورة قياسية بدون معالجة' : 'Before: Standard Unconditioned Cabin',
                'after_label' => $isAr ? 'بعد: عناية فائقة وحماية للفرش الداخلي' : 'After: Deep Conditioning & Leather Shield',
                'warranty' => $isAr ? 'ضمان غسيل آمن 100%' : '100% Scratch-Free Guarantee',
                'duration_hours' => 2,
                'features' => $isAr ? [
